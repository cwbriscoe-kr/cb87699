--2014-02-19 128452 results
--2014-02-24 120454 results
--2014-02-25 120372 results
--2014-03-05 119902 results
--2014-03-11 118809 results
--2014-03-19 117701 results
--2014-03-27 115560 results
--2014-05-09 108760 results
--2014-05-21 107979 results
--2014-07-29 not valid any longer since we now default cpn_sku_qy to zero for non-components
with skutyp as (
...
data as (                                                        
SELECT results.itm_no
      ,k15.*                                         
  FROM prd.K15_PID_CASCO k15
      ,RESULTS    
 where k15.cas_upc_no = results.cas_upc_no
   and k15.con_upc_no = results.con_upc_no      
   and (k15.cas_con_qy = 1 or k15.cas_con_cnt_qy = 1)  
)
select * from data                               
